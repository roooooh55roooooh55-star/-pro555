...
const App: React.FC = () => {
  ...
  // 🧠 AI Logic: خوارزمية التوصية الذكية (SmartBrain Connected)
  // This uses the SmartLogic generateVideoFeed method now.
  ...
  const playLongVideo = (v: Video, list?: Video[]) => {
      SmartBrain.saveInterest(v.category);
      // Ensure list is present for infinite playback
