          ...
          {section.type === 'shorts_grid' && (
            <div className="w-full h-full grid grid-cols-2 grid-rows-2 gap-2">
               {getVideosForSection(4, 'Shorts').map(v => {
                 ...
                 return (
                   <div key={v.id} onClick={() => onPlayShort(v, videos.filter(x => x.video_type === 'Shorts'))} className={`rounded-xl overflow-hidden relative border-2 ${neonStyle} bg-transparent shadow-none`}>
                      <SafeAutoPlayVideo 
